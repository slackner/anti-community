...
static void usage(const char *argv0)
{
    ...
    fprintf(stderr, "\n");
    fprintf(stderr, "Return connected components of an undirected graph.\n");
    fprintf(stderr, "\n");
...
int main(int argc, char *argv[])
{
    ...
    if ((labels = graph_get_connected_components(g)))
    {
        fprintf(stderr, "Graph consists of %u component(s)\n", count_labels(labels, g->num_nodes));
